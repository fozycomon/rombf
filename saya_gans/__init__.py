...
class awokawokawok:
	...
	def main_menu(self):
		...
		print(52*'\x1b[1;97m═')
		print(P+" [1] crack dari daftar teman")
		print(P+" [2] crack dari daftar teman publik")
		print(P+" [3] crack dari followers")
		print(P+" [4] crack dari pencarian nama")
		print(P+" [5] crack dari group")
		print(P+" [6] crack dari permintaan pertemanan")
		print(P+" [7] crack dari like postingan")
		print(P+" ["+H+"8"+P+"] "+H+"update tools")
		print(P+" ["+M+"9"+P+"] "+M+"hapus cookie")
		print(P+" ["+M+"0"+P+"] "+M+"Keluar")
		print(52*'\x1b[1;97m═')
		...
		if pilih in ("3","03"):
			...
			exit(" \x1b[1;91m[!] Gagal menghapus cookie " if os.path.exists("cookies/info.txt") else ""+H+" [âœ“] sukses menghapus cookie")
